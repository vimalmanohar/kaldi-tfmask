...
int main(int argc, char *argv[]) {
  try {
    ...
    const char *usage =
      "Convert targets for IRM training to actual IRM\n"
      "Usage: irm-targets-to-irm [options] <in-rspecifier> <out-wspecifier>\n"
      "e.g.: irm-targets-to-irm ark:- ark,scp:foo.ark,foo.scp\n";
