...
inline void cuda_comp_obj_deriv_xent_sum(dim3 Gr, dim3 Bl, MatrixElement<double>* x, int32 size, int32 td, const double* z, MatrixDim d, double* z2, MatrixDim d2, double* t) {cudaD_comp_obj_deriv_xent(Gr,Bl,x,size,td,z,d,z2,d2,t); }
