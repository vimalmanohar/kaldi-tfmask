...
inline void cuda_diff_relu(dim3 Gr, dim3 Bl, float *eout, const float *e, const float *y, MatrixDim d) { cudaF_diff_relu(Gr,Bl,eout,e,y,d); }
...
inline void cuda_comp_obj_deriv_xent_sum(dim3 Gr, dim3 Bl, MatrixElement<float>* x, int32 size, const float* z, MatrixDim d, float* z2, MatrixDim d2, float* t) {cudaF_comp_obj_deriv_xent_sum(Gr,Bl,x,size,z,d,z2,d2,t); }
...
inline void cuda_diff_relu(dim3 Gr, dim3 Bl, double *eout, const double *e, const double *y, MatrixDim d) { cudaD_diff_relu(Gr,Bl,eout,e,y,d); }
...
inline void cuda_comp_obj_deriv_xent_sum(dim3 Gr, dim3 Bl, MatrixElement<double>* x, int32 size, const double* z, MatrixDim d, double* z2, MatrixDim d2, double* t) {cudaD_comp_obj_deriv_xent_sum(Gr,Bl,x,size,z,d,z2,d2,t); }
